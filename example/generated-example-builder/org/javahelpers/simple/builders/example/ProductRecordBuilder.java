 ...
 * <p>
 * This builder provides a fluent API for creating instances of org.javahelpers.simple.builders.example.ProductRecord
...
@BuilderImplementation(forClass = ProductRecord.class)
public class ProductRecordBuilder implements IBuilderBase<ProductRecord> {
   ...
   */
  ProductRecordBuilder validateCategory() {
   ...
   */
  ProductRecordBuilder validateName() {
   ...
   */
  public ProductRecordBuilder conditional(BooleanSupplier condition, Consumer<ProductRecordBuilder> yesCondition) {
   ...
   * @return this builder instance
   */
  public ProductRecordBuilder conditional(BooleanSupplier condition, Consumer<ProductRecordBuilder> trueCase,
      Consumer<ProductRecordBuilder> falseCase) {
    ...
    default ProductRecord with(Consumer<ProductRecordBuilder> b) {
      ...
      try {
        ...
        throw new IllegalArgumentException(
            "The interface 'ProductRecordBuilder.With' should only be implemented by classes, which could be casted to 'ProductRecord'",
            ex);
      }
      b.accept(builder);

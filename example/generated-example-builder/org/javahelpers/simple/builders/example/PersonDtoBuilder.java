 ...
 * <p>
 * This builder provides a fluent API for creating instances of org.javahelpers.simple.builders.example.PersonDto with
...
public class PersonDtoBuilder implements IBuilderBase<PersonDto> {
   ...
   * 
   * <pre>{@code
   * builder.mapNickNames2(String::trim);
   * }</pre>
   * 
